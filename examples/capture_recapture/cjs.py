...
def main(args):
    ...
    if args.tmc:
        ...
        elbo = TensorMonteCarlo(max_plate_nesting=1).differentiable_loss
        tmc_model = poutine.infer_config(
            model,
            lambda msg: {"num_samples": 20, "expand": False} if msg["infer"].get("enumerate", None) == "parallel" else {})  # noqa: E501
